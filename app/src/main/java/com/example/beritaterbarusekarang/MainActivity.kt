...
@Composable
fun AffirmationList(affirmationList: List<Tampil>, modifier: Modifier = Modifier) {
...
@Composable
fun AffirmationCard(affirmation: Tampil, modifier: Modifier = Modifier) {
...
private fun AffirmationCardPreview() {
    AffirmationCard(Tampil(R.string.coba1, R.drawable.gambar1))
}
